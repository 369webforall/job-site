...
const HeroSection = () => {
  return (
    <section className="relative">
      ...
      <div className="absolute z-10 top-0 left-0 md:left-10 lg:left-28  mx-auto max-w-screen-xl px-4 py-4 sm:px-6 lg:flex sm:h-[90vh] lg:h-[80vh] sm:items-start lg:items-center lg:px-8">
